...
// NOTE: the real size is 4096, but there is a small bug in the test harness that causes us to stop early
...
void oram_read(int fd, int addr);
void oram_write(int fd, int addr);
